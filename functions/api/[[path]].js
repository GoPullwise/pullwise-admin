...
export async function onRequest(context) {
  ...
  if (await shouldRetryCloudflare1003(response, upstreamOrigin, context.env, context.request)) {
    const fallbackOrigin = apiOrigin(context.env.PULLWISE_API_FALLBACK_ORIGIN || "");
